#include "Ponia/Modules/src/DiMuonCandProducer.h"
...
void
DiMuonCandProducer::produce(edm::Event& iEvent, const edm::EventSetup& iSetup)
{  
  using namespace edm;
  using namespace std;
...
DEFINE_FWK_MODULE(DiMuonCandProducer);
